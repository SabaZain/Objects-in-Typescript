// Object in Typescript - An Object is a composite data structure that allows to store multiple key-value pairs.
// Example 
type UniversityStudent = {
    ...
    emailId: string
    courseTitle:string,
    coursesTaken:[string,string,string],
    semester:string,
    grades:{},
    isPassed?: boolean
};

let student1:UniversityStudent = {
    name: "Maria",
    studentId:"CS001160",
...
let student2:UniversityStudent = {
    name: "Sana",
    studentId:"CS001164",
...
let student3:UniversityStudent = {
    name: "Ali",
    studentId:"CS001172",
